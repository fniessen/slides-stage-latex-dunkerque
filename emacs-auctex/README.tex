...
\begin{frame}[label={sec:orgbbecbe2}]{Notation des raccourcis clavier}
\begin{figure}[!htbp]
\centering
...
\begin{frame}[label={sec:org28aab45}]{Manipuler un fichier}
\begin{description}
...
\begin{frame}[label={sec:orge182c23}]{Manipuler un écran}
...
\begin{frame}[label={sec:orgb986c6b}]{Annuler}
\begin{description}
...
\begin{frame}[label={sec:org874b0a7}]{Couper / Copier / Coller}
\begin{description}
...
\begin{frame}[fragile,label={sec:orgc2f0856}]{Chercher}
 \begin{description}
...
\begin{frame}[label={sec:org9299cd2}]{Obtenir de l'aide}
\begin{description}
\item[{\keys{C-h} \keys{t}}] Accéder au tutorial d'Emacs
\end{description}
\end{frame}

\begin{frame}[fragile,label={sec:org3d6dbe6}]{Configurer Emacs}
 \begin{itemize}
...
\begin{frame}[label={sec:org0201019}]{Fonctionnalités supplémentaires}
...
\begin{frame}[fragile,label={sec:org860decb}]{Vérification orthographique à la volée}
 \lstset{language=Lisp,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:orgfbda853}]{Vérification syntaxique à la volée}
 \lstset{language=Lisp,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
(require 'flymake)
...
\begin{frame}[fragile,label={sec:org328fea8}]{Mise en forme du texte}
 \begin{description}
...
\begin{frame}[fragile,label={sec:org433942f}]{Insertion de sections}
 \begin{description}
...
\begin{frame}[label={sec:orga45d832}]{Insertion de commandes}
\begin{description}
...
\begin{frame}[fragile,label={sec:orgfa6fc4a}]{Insertion d'environnements}
 \begin{description}
...
\begin{frame}[fragile,label={sec:orgfc04f92}]{Compilation}
 \begin{description}
...
\begin{frame}[label={sec:org2ccb9fa}]{Formatage}
\begin{description}
...
\subsection{RefTeX}
\label{sec:orgccc1ada}

\begin{frame}[fragile,label={sec:org6ec1158}]{Description}
...
\begin{frame}[label={sec:org0235cb7}]{Table des matières}
\begin{description}
...
\begin{frame}[fragile,label={sec:orgb5b6557}]{Outline}
...
\begin{frame}[label={sec:orgfc8d10a}]{Édition de rectangles}
\begin{description}
