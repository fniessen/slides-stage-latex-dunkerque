...
#+SETUPFILE: "~/.dotfiles/org/theme-bigblow.setup"
...
\begin{tikzpicture}[remember picture,overlay,huge/.style={font=\Huge, inner sep=.3cm}]
  \node[huge,right, align=left, rotate=5, yshift=-2.8cm, opacity=0.85, text width=4.4cm, minimum height=8.5cm, fill=white] {\color{red!80!black}Emacs +\\ Org mode\\ (n.m.) :\\ \color{black!65}Assurance\\ d'être\\ bien plus \\productiikzpicture}
#+END_EXPORT
