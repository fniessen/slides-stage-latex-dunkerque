...
\section{Contexte}
\label{sec:org3a0a4f9}

\begin{frame}[label={sec:org80666e8}]{Contexte}
\begin{quote}
...
\begin{frame}[label={sec:org55df207}]{Agenda}
\begin{center}
...
\begin{frame}[label={sec:org3a36718}]{Présentation}
\begin{columns}
...
\label{sec:org9928ac9}

\begin{frame}[fragile,label={sec:orgd370e18}]{Liste \og à puces\fg{} en \LaTeX{}}
 Code \LaTeX{}
...
\begin{frame}[fragile,label={sec:org9cc3e17}]{Liste numérotée en \LaTeX{}}
 Code \LaTeX{}
...
\begin{frame}[fragile,label={sec:org7040d3a}]{Liste de description en \LaTeX{}}
 Code \LaTeX{}
...
\begin{frame}[fragile,label={sec:org3344cc6}]{Tableau en \LaTeX{}}
 \begin{columns}
...
\begin{frame}[fragile,label={sec:orge7bea97}]{Tableau en \LaTeX{}}
 \begin{itemize}
...
\begin{frame}[plain,label={sec:org96a46e3}]{Mais on a toujours fait comme cela\ldots{}}
...
\label{sec:org2bfcf23}

\begin{frame}[plain,label={sec:orgf79da6e}]{Org à la rescousse}
\setbeamertemplate{navigation symbols}{}
\begin{tikzpicture}[remember picture,overlay]
    \node[xshift=0cm,yshift=0cm] at (current page.center) {
...
\begin{frame}[fragile,label={sec:orgdc11c2d}]{Mise en forme}
 Balisage virtuellement inexistant

\begin{columns}
\begin{column}{0.48\columnwidth}
\lstset{language=org,label=orgfb0255a,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
Normal
...
\begin{frame}[fragile,label={sec:org71705a0}]{Liste \og à puces\fg{} en Org mode}
 Affichage
...
\begin{frame}[fragile,label={sec:orgbcc3243}]{Liste numérotée en Org mode}
 Affichage
...
\begin{frame}[fragile,label={sec:orga9d092d}]{Liste de description en Org mode}
 Affichage
...
\begin{frame}[fragile,label={sec:org9a2e175}]{Tableau en Org mode}
 \begin{columns}
...
\begin{frame}[label={sec:org68cb4a8}]{Création de tableaux}
\begin{itemize}
...
\begin{frame}[label={sec:org8743b0e}]{Édition de tableaux}
\begin{itemize}
\item Pour supprimer
\begin{itemize}
...
\begin{frame}[label={sec:org92dfca4}]{Édition de tableaux}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:orgc1a27e4}]{Tableur}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org6b4c78b}]{Références}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgdf5357f}]{Formules}
 \begin{columns}
\begin{column}{0.55\columnwidth}
Syntaxe Org

\lstset{language=org,label=org4c73dbe,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:org21b802f}]{Formules}
 \begin{itemize}
...
\begin{frame}[label={sec:orgd150118}]{Fonctions}
\begin{itemize}
...
\begin{frame}[label={sec:orga0d3316}]{Fonctions}
\begin{itemize}
\item Statistique
\begin{center}
\begin{tabular}{ll}
...
\begin{frame}[fragile,label={sec:org816d475}]{Format}
 \begin{center}
\begin{tabular}{ll}
...
\begin{frame}[fragile,label={sec:orgc35a230}]{Assistance à l'édition de la ligne \texttt{\#+TBLFM}}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orge507b13}]{Tableau Org dans source \LaTeX{}}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orge3e185f}]{Code en R}
...
\begin{frame}[label={sec:org3b966e2}]{Graphique généré en R}
\begin{columns}
\begin{column}{0.36\columnwidth}
\begin{table}[!htbp]
\caption{\label{tab:orgc73a87f}
Achats par mois}
\centering
\begin{tabular}{lr}
Mois & Montant\\
...
\begin{frame}[label={sec:orgf436a4a}]{Graphique généré en PGFPlots}
\begin{columns}
\begin{column}{0.36\columnwidth}
\begin{tikzpicture}[font={\rmfamily}]
...
\begin{frame}[fragile,label={sec:org49573aa}]{Code SQL}
 \lstset{language=org,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:org4350a07}]{Autres environnements}
 Blocs spéciaux
...
\begin{frame}[fragile,label={sec:orgcac7a3a}]{Sectionnement}
...
\begin{frame}[label={sec:org39574ea}]{Édition de la structure}
\begin{itemize}
\item \alert{Section}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:org513ef81}]{Visibilité}
 \lstset{language=org,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
* Introduction...
* Expériences...
...
\begin{frame}[fragile,label={sec:org6ac47a7}]{Écrire un rapport}
 \lstset{language=org,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:org2387f37}]{Générer un index}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgc5ef4fb}]{Écrire une présentation}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org91bef4e}]{Écrire un examen}
...
\begin{frame}[label={sec:org611b135}]{Écrire une documentation logicielle}
...
\begin{frame}[fragile,label={sec:orgba79310}]{Coloration syntaxique}
 \begin{itemize}
\item À l'export
...
\begin{frame}[label={sec:orgf44596f}]{Écrire une thèse}
...
\begin{frame}[fragile,label={sec:org81b02e0}]{Exécution de blocs de code}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orge7342a4}]{Mathématiques}
...
\begin{frame}[fragile,label={sec:orge6377e4}]{Écrire une lettre}
...
\begin{frame}[label={sec:orgd315366}]{Exporter le document Org}
...
\begin{frame}[label={sec:org2c1e695}]{Exporter en Beamer}
\begin{columns}
\begin{column}{0.48\columnwidth}
\begin{center}
...
\begin{frame}[fragile,label={sec:orgb6d3786}]{Exports à jour}
 \lstset{language=Lisp,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[label={sec:org8d8ad53}]{Suppléments non abordés}
\begin{itemize}
...
\section{Conclusion}
\label{sec:org0045119}

\begin{frame}[<+->][label={sec:org1b7808a}]{Cliquer ici}
...
\begin{frame}[label={sec:org082c21f}]{Conclusion}
\begin{itemize}
...
\begin{frame}[plain,label={sec:org2bb5700}]{Conclusion}
\setbeamertemplate{navigation symbols}{}
\begin{tikzpicture}[remember picture,overlay]
    \node[xshift=0cm,yshift=0cm] at (current page.center) {
...
\begin{frame}[label={sec:org46f271d}]{Coordonnées}
Fabrice Niessen \\
