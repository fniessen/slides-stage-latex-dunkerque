...
\section{Contexte}
\label{sec:org45b8cdb}

\begin{frame}[label={sec:org7f8d985}]{Contexte}
\begin{quote}
...
\begin{frame}[label={sec:org4012ac6}]{Agenda}
\begin{center}
...
\begin{frame}[label={sec:org02639d5}]{Présentation}
\begin{columns}
...
\begin{frame}[plain,label={sec:org823abb1}]{Définition}
...
\begin{frame}[fragile,label={sec:org3f53a59}]{Tableau en \LaTeX{}}
 \begin{itemize}
...
\begin{frame}[plain,label={sec:orgb163748}]{Mais on a toujours fait comme cela\ldots{}}
\setbeamertemplate{navigation symbols}{}
\begin{tikzpicture}[remember picture,overlay]
    \node[xshift=0cm,yshift=0cm] at (current page.center) {
...
\label{sec:org4b7e5e3}

\begin{frame}[plain,label={sec:org4d6051a}]{Org à la rescousse}
\setbeamertemplate{navigation symbols}{}
\begin{tikzpicture}[remember picture,overlay]
    \node[xshift=0cm,yshift=0cm] at (current page.center) {
...
\begin{frame}[fragile,label={sec:orgb264df2}]{Mise en forme}
 Balisage virtuellement inexistant

\begin{columns}
\begin{column}{0.48\columnwidth}
\lstset{language=org,label=orgb8cd06e,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
Normal
...
\begin{frame}[fragile,label={sec:org1a5fc58}]{Liste \og à puces\fg{} en Org mode}
 Affichage
...
\begin{frame}[fragile,label={sec:orgd14b563}]{Liste numérotée en Org mode}
 Affichage
...
\begin{frame}[fragile,label={sec:org7971ec9}]{Liste de description en Org mode}
 Affichage
...
\begin{frame}[fragile,label={sec:orgc8e1c75}]{Tableau en Org mode}
 \begin{columns}
...
\begin{frame}[label={sec:orgf0d3b9a}]{Création de tableaux}
\begin{itemize}
...
\begin{frame}[label={sec:org28c8dfa}]{Édition de tableaux}
\begin{itemize}
\item Pour supprimer
\begin{itemize}
...
\begin{frame}[fragile,label={sec:org75e6950}]{Références}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orge0b4989}]{Formules}
 \begin{columns}
\begin{column}{0.55\columnwidth}
Syntaxe Org

\lstset{language=org,label=orgceff1c1,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:org80bc3ca}]{Formules}
 \begin{itemize}
...
\begin{frame}[label={sec:orgfab433a}]{Fonctions}
\begin{itemize}
...
\begin{frame}[label={sec:org9f48311}]{Fonctions}
\begin{itemize}
\item Statistique
\begin{center}
\begin{tabular}{ll}
...
\begin{frame}[fragile,label={sec:orgbc3da7c}]{Format}
 \begin{center}
\begin{tabular}{ll}
...
\begin{frame}[fragile,label={sec:org5b97865}]{Assistance à l'édition de la ligne \texttt{\#+TBLFM}}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org472b5f7}]{Tableau Org dans source \LaTeX{}}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org219abc7}]{Code en R}
...
\begin{frame}[label={sec:org37f1fd5}]{Graphique généré en R}
\begin{columns}
\begin{column}{0.36\columnwidth}
\begin{table}[!htbp]
\caption{\label{tab:org3445771}
Achats par mois}
\centering
\begin{tabular}{lr}
Mois & Montant\\
...
\begin{frame}[label={sec:org75b3451}]{Graphique généré en PGFPlots}
\begin{columns}
\begin{column}{0.36\columnwidth}
\begin{tikzpicture}[font={\rmfamily}]
...
\begin{frame}[fragile,label={sec:org2f6bd71}]{Code SQL}
 \lstset{language=org,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:org6d6d2b3}]{Autres environnements}
 Blocs spéciaux
...
\begin{frame}[fragile,label={sec:org0d39a5d}]{Sectionnement}
...
\begin{frame}[label={sec:org4d16038}]{Édition de la structure}
\begin{itemize}
\item \alert{Section}
\begin{itemize}
...
\begin{frame}[fragile,label={sec:orgb86baef}]{Visibilité}
 \lstset{language=org,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
* Introduction...
* Expériences...
...
\begin{frame}[fragile,label={sec:org728e712}]{Écrire un rapport}
 \lstset{language=org,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[fragile,label={sec:orgf8b3f72}]{Générer un index}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:orgc7a1dfd}]{Écrire une présentation}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org24b7114}]{Écrire un examen}
...
\begin{frame}[label={sec:org0d06a0e}]{Écrire une documentation logicielle}
...
\begin{frame}[fragile,label={sec:orgdf2ce67}]{Coloration syntaxique}
 \begin{itemize}
\item À l'export
...
\begin{frame}[label={sec:orgabbd3fe}]{Écrire une thèse}
...
\begin{frame}[fragile,label={sec:orgfe7c621}]{Exécution de blocs de code}
 \begin{itemize}
...
\begin{frame}[fragile,label={sec:org73f319c}]{Mathématiques}
...
\begin{frame}[fragile,label={sec:orgd7a3f02}]{Écrire une lettre}
...
\begin{frame}[label={sec:orgb31da10}]{Exporter le document Org}
...
\begin{frame}[label={sec:org66f208d}]{Exporter en Beamer}
\begin{columns}
\begin{column}{0.48\columnwidth}
\begin{center}
...
\begin{frame}[fragile,label={sec:org4850572}]{Exports à jour}
 \lstset{language=Lisp,label= ,caption= ,captionpos=b,numbers=none}
\begin{lstlisting}
...
\begin{frame}[label={sec:org2a5ada4}]{Suppléments non abordés}
\begin{itemize}
...
\section{Conclusion}
\label{sec:org94488c8}

\begin{frame}[<+->][label={sec:orgceb3a86}]{Cliquer ici}
...
\begin{frame}[label={sec:orgb90d885}]{Conclusion}
\begin{itemize}
...
\begin{frame}[plain,label={sec:org722a5ed}]{Conclusion}
\setbeamertemplate{navigation symbols}{}
\begin{tikzpicture}[remember picture,overlay]
    \node[xshift=0cm,yshift=0cm] at (current page.center) {
